...
export default function AnimeDetailDialog({
  ...
  const currentTitle =
    allTitles[currentTitleIndex] || anime.title.english || anime.title.romaji;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[3412px] w-[90vw] max-h-[90vh] overflow-y-auto bg-[#3a3a3a] animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div
            className="flex items-center justify-center gap-2 w-full animate-in fade-in slide-in-from-top-4 duration-500"
          ...
          <div
            className="w-full max-w-4xl space-y-2 text-center animate-in fade-in slide-in-from-bottom-4 duration-500"
            style={{ animationDelay: "300ms" }}
          >
            <p className="text-base text-muted-foreground">
              <span className="font-medium">Status:</span>{" "}
              {anime.status ? getStatusLabel(anime.status) : "Unknown"}
            </p>
            <p className="text-base text-muted-foreground">
          ...
          <div
            className="flex items-center justify-between pt-6 border-t border-border/50 flex-wrap gap-4 w-full animate-in fade-in slide-in-from-bottom-4 duration-500"
