...
export default function CreateWatchlistDialog({ open, onOpenChange }: CreateWatchlistDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-black border-4 border-yellow-500 text-white">
        <DialogHeader>
          <DialogTitle className="text-yellow-500 text-xl">Create New Watchlist</DialogTitle>
        </DialogHeader>

        <div className="space-y-4 py-4">
          <div>
            <Label htmlFor="name" className="text-gray-300">Watchlist Name</Label>
            <Input
              id="name"
              value={name}
